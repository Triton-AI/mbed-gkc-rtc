...
// Return a product string descriptor to display "GTK Controller Passthrough".
// The string has 26 characters; its total descriptor length = 2 + (26 * 2) = 54 bytes (0x36).
...
// Return a manufacturer string descriptor to display "UCSD".
// "UCSD" has 4 characters so the total descriptor length is 2 + (4 * 2) = 10 bytes.
